...
<div x-cloak x-show="$wire.show"
    class="bg-[#412A5B] text-black rounded-xl fixed p-6 top-[1%] left-[1%] z-50 flex flex-col items-start justify-center w-[98%] h-[98%] md:items-center backdrop-filter backdrop-blur bg-gray-800/50">
